...
if(isset($_POST['signup'])){
    ...
    if(count($errors) === 0){
        ...
        $will_id = $_GET['id'];
        $will_date = date('Y-m-d H:i:s');
        
        $insert_will = "INSERT INTO will(user_id, will_id, will_date,will_time) values ('$id', '$id', '$will_date', CURRENT_TIMESTAMP)";
        if($data_check){
            $subject = "Email Verification Code";
            $message = "Your verification code is $code";
            $sender = "From: noreply@dems.com";
